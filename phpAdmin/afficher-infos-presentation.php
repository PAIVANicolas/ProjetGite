<form method="post" id="updateForm">
    ...
    <textarea name="presentation" id="presentation" class="input-texte" rows="5"
              placeholder="Entrez le nouveau texte de présentation ici"></textarea><br>
    ...
    <section class="row">
        <fieldset>
            ...
            <input type="text" name="tarif_semaine_moyenne" id="tarif_semaine_moyenne" class="input-texte"
                   placeholder="€"><br>

            <label class="title-form">Nuitée Moyenne Saison:</label>
            <input type="text" name="tarif_nuitee_moyenne" id="tarif_nuitee_moyenne" class="input-texte"
                   placeholder="€"><br>

            <label class="title-form">Semaine Haute Saison:</label>
            <input type="text" name="tarif_semaine_haute" id="tarif_semaine_haute" class="input-texte"
                   placeholder="€"><br>

            <label class="title-form">Nuitée Haute Saison:</label>
            <input type="text" name="tarif_nuitee_haute" id="tarif_nuitee_haute" class="input-texte"
                   placeholder="€"><br>
        </fieldset>
